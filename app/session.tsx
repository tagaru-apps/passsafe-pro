...
const styles = StyleSheet.create({ screen: { backgroundColor: colors.background }, content: { padding: 18, paddingBottom: 25 }, top: { flexDirection: "row", alignItems: "center", gap: 18, marginBottom: 18 }, progressGroup: { flex: 1 }, progressLabel: { color: colors.textSecondary, fontSize: 12, textAlign: "right", marginTop: 6, fontWeight: "700" }, close: { width: 34, height: 34, borderRadius: 17, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.border }, questionCard: { padding: 20 }, badges: { flexDirection: "row", flexWrap: "wrap", gap: 6 }, question: { color: colors.text, fontSize: 19, lineHeight: 27, fontWeight: "800", marginTop: 17 }, questionMeta: { color: "#9CA3AF", fontSize: 11, fontWeight: "700", marginTop: 15, letterSpacing: 0.5 }, answers: { gap: 11, marginTop: 16 }, answer: { minHeight: 64, borderRadius: 14, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: colors.border, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 12 }, answerCorrect: { backgroundColor: "#F0FDF4", borderWidth: 2, borderColor: colors.primary }, answerWrong: { backgroundColor: "#FEF2F2", borderWidth: 2, borderColor: colors.danger }, letter: { width: 36, height: 36, borderRadius: 18, backgroundColor: "#F3F4F6", alignItems: "center", justifyContent: "center" }, letterSelected: { backgroundColor: colors.primary }, letterCorrect: { backgroundColor: "#D1FAE5" }, letterWrong: { backgroundColor: "#FECACA" }, letterText: { color: colors.text, fontSize: 13, fontWeight: "800" }, letterTextSelected: { color: "#FFFFFF" }, answerText: { color: colors.text, fontSize: 14, fontWeight: "600", flex: 1, lineHeight: 20 }, answerTextSelected: { color: "#FFFFFF" }, explanation: { borderLeftWidth: 4, borderLeftColor: colors.primary, padding: 17, marginTop: 17 }, answerOutcome: { fontSize: 14, fontWeight: "800" }, correctText: { color: colors.primary }, wrongText: { color: colors.danger }, explanationText: { color: "#374151", fontSize: 13, lineHeight: 19, marginTop: 9 }, tip: { backgroundColor: "#FFFBEB", borderRadius: 10, padding: 12, marginTop: 13 }, tipTitle: { color: "#92400E", fontSize: 10, fontWeight: "800", letterSpacing: 0.7 }, tipText: { color: "#92400E", fontSize: 12, lineHeight: 17, marginTop: 5 }, continueWrap: { marginTop: 16 }, pressed: { opacity: 0.9, transform: [{ scale: 0.98 }] }, empty: { backgroundColor: colors.background, padding: 24, alignItems: "center", justifyContent: "center", gap: 18 }, emptyText: { color: colors.text, textAlign: "center", fontSize: 16, fontWeight: "700" }, });
