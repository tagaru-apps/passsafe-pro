...
const styles = StyleSheet.create({ screen: { backgroundColor: colors.background, padding: 24 }, content: { flex: 1, alignItems: "center", justifyContent: "center" }, contentCompact: { justifyContent: "flex-start", paddingTop: 8 }, trophy: { fontSize: 60 }, trophyCompact: { fontSize: 46 }, title: { color: colors.primary, fontSize: 27, fontWeight: "800", textAlign: "center", marginTop: 12 }, titleCompact: { fontSize: 23, marginTop: 7 }, subtitle: { color: colors.textSecondary, fontSize: 14, textAlign: "center", lineHeight: 20, marginTop: 8, paddingHorizontal: 12 }, scoreCard: { marginTop: 24, padding: 23, alignSelf: "stretch", alignItems: "center" }, scoreCardCompact: { marginTop: 16, padding: 17 }, score: { color: colors.primary, fontSize: 48, fontWeight: "800", lineHeight: 55 }, scoreCompact: { fontSize: 40, lineHeight: 46 }, percent: { color: colors.textSecondary, fontSize: 14, marginTop: 3 }, stats: { flexDirection: "row", gap: 10, marginTop: 21, alignSelf: "stretch" }, stat: { flex: 1, backgroundColor: colors.background, borderRadius: 10, padding: 11, alignItems: "center" }, statValue: { color: colors.text, fontSize: 15, fontWeight: "800" }, statLabel: { color: colors.textSecondary, fontSize: 10, marginTop: 4 }, actions: { alignSelf: "stretch", marginTop: 24, gap: 12 }, actionsCompact: { marginTop: 17, gap: 9 }, ad: { marginTop: 18, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 15 }, adText: { color: "#9CA3AF", fontSize: 10, flex: 1, textAlign: "center", lineHeight: 14 }, });
